...
/**
 * The morePacketsCheck (previously called SpeedhackCheck) will try to identify players that send more than the usual amount of move-packets to the server to be able to move faster than normal, without getting caught by the other checks (flying/running).
 * 
 * It monitors the number of packets sent to the server within 1 second and compares it to the "legal" number of packets for that timeframe (22).
 * 
 */
