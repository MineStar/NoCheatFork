...
/**
 * Configurations specific for the "Inventory" checks Every world gets one of these assigned to it, or if a world doesn't get it's own, it will use the "global" version
 * 
 */
