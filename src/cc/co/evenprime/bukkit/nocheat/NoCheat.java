...
import com.bukkit.gemo.FlyModProtection.FMProtectionCore;
...
public class NoCheat extends JavaPlugin implements Listener {
    ...
    private FMProtectionCore zonePlugin;

    public NoCheat() {
        zonePlugin = new FMProtectionCore(this);
    }
