...
/**
 * A list of actions, that associates actions to tresholds. It allows to retrieve all actions that match a certain treshold
 * 
 */
public class ActionList {
     ...
     * @param actions
     *            The actions that will be used if the player reached the accompanying treshold/violation level
     */
